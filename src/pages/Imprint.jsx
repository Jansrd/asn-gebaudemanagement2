  ...
  return (
    <div className="imprint">
      <div className="imprint-content" id="imprint-content">
        ...
        <div className="imprint-employer">
          <p>
            Eckstraße 7 <br></br>
            89250 Senden<br></br>
            <span>Inhaber:</span>
        ...
        <div className="imprint-disclaimer">
          ...
          <p>
            ...
            Bekanntwerden von entsprechenden Rechtsverletzungen wir diese
          ...
          <p>
            ...
            dem zuvor benannten Zweck einverstanden.Website Impressum erstellt
            durch
            <span>
              <a
